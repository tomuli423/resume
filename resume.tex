...
\geometry{left=1.4cm, top=2.5cm, right=1.4cm, bottom=1.8cm, footskip=.5cm}
...
\mobile{+886-986625567}
\email{leetomu423@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{tomuli.cc} 
\github{github.com/tomuli423}
\linkedin{linkedin.com/in/tomuli}
% \gitlab{gitlab-id}
